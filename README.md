...
- Orchestration Agent - An orchestrator of a multi-agent article writing system whose job is to coordinate tools and other agents to produce a high-quality article. Orchestrator coordinates between two specialized tools to collect content and image, and handoffs to writer agents for the final output:
